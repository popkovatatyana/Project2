...
#Программа работает для всех тем,толькj нужно смотреть уровень заголовка,
#используемый в HTMl страницы по конкретной теме, и изменять в зависимости от этого уровень заголовка в регулярном выражении в моей программе 
